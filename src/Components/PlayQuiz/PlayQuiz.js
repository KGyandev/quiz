  ...
  return (
    ...
    >
      <div className="play-quiz-main">
        ...
        In a world driven by curiosity and the quest for knowledge, there's a growing demand for interactive and engaging ways to learn,
         challenge oneself, and have fun. Welcome to QuizMaster, your gateway to a world of quizzes and endless opportunities to test
          your knowledge, explore new topics, and compete with friends and fellow enthusiasts.

QuizMaster is more than just a quiz platform; it's a dynamic, user-centric ecosystem designed to cater to the diverse interests and learning needs of our users. Whether you're a lifelong learner, an educator, a trivia buff, or someone looking for a casual brain teaser, QuizMaster offers something for everyone.
        </div>
